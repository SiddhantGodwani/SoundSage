#Added seperate tab for error logs
...
# Create tabs
tabs = st.tabs(["Music Recommendation System", "Error Log"])

# Display the main app in the first tab
with tabs[0]:
    ...
    if track_name:
        try:
            # ... your existing code for getting recommendations ...
            ...
            # Display the error message in the second tab
            with tabs[1]:
                st.error(f"Error: {e}")

# Display the error log in the second tab
with tabs[1]:
    st.write("This tab will display any errors that occur during the recommendation process.")
